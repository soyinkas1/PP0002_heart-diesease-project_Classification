...
class WebForm(FlaskForm):
    ...
    cp = SelectField('Chest Pain Type)', choices=[(1, 'typical angina'),(2, 'atypical angina'),(3, 'non-anginal pain'), (4, 'asymptomatic')], validate_choice=True)
    ...
    fbs = SelectField('(Fasting blood sugar &gt; 120 mg/dl) (1 = True; 0 = False)', choices=[(1, 'True'), (0, 'False')], validate_choice=True)
    restecg = SelectField('Resting electrocardiographic results', choices=[(0, '0'), (1, '1'), (2, '2')], validate_choice=True)
    thalach = IntegerField('Maximum heart rate achieved', default=0 ,validators=[InputRequired()])
    exang = SelectField('Sex (1 = Yes; 0 = No)', choices=[(1, 'Yes'), (0, 'No')], validate_choice=True)
    oldpeak = FloatField('ST depression induced by exercise relative to rest', default=0.00 ,validators=[InputRequired()])
    slope = SelectField('the slope of the peak exercise ST segment', choices=[(0, '0'), (1, '1'), (2, '2')], validate_choice=True)
    ca = SelectField('Number of major vessels (0-3) colored by flourosopy', choices=[(0, '0'),(1, '1'),(2, '2'), (3, '3')], validate_choice=True)
    thal = SelectField('1 = normal; 2 = fixed defect; 3 = reversable defect', choices=[(1, 'Normal'), (2, 'fixed defect'), (3, 'reversable defect')], validate_choice=True)
